...
namespace Practicando0318.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(Practica0318DbContext context)
        {
            _context = context;
        }
        ...
        {
            var practica0318DbContext = _context.Productos.Include(p => p.Categoria).Include(p => p.Marca);
            return View(await practica0318DbContext.ToListAsync());
        }
